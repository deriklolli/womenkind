...
const ALL_DOMAINS = [
  ...
  { key: 'sleep',     label: 'Sleep',          Icon: Moon,      color: '#5d9ed5', subtitle: 'Sleep / nightly avg',       improvesDown: false, tags: { improving: 'Deeper cycles',   watch: 'Disrupted',       steady: 'Consistent'     } },
  ...
  { key: 'mood',      label: 'Mood',           Icon: SmilePlus, color: '#944fed', subtitle: 'Emotional wellness',  improvesDown: false, tags: { improving: 'Steadier days',   watch: 'More variable',   steady: 'Consistent'     } },
        ...
        <div className="bg-white rounded-card shadow-sm border border-aubergine/5 px-5 py-3 flex items-center gap-4">
          <div className="flex items-end gap-1 shrink-0">
            {overallNow !== undefined ? (
              <>
                <span className="font-serif font-normal text-[48px] leading-none text-aubergine">{displayScore}</span>
          ...
          <div className="shrink-0">
            {isInitialState && wmiScores ? (
              ...
              <span className={`inline-flex items-center gap-1.5 text-xs font-sans px-3 py-1 rounded-pill ${
