...
export default function VisitPrepPanel({ appointmentId, patientId, patientName, onClose }: VisitPrepPanelProps) {
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-sans font-semibold text-violet bg-violet/5 border border-violet/15 rounded-pill hover:bg-violet/10 transition-colors"
              >
                {patientName}
