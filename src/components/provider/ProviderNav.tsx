...
export default function ProviderNav() {
  ...
  return (
    <nav className="w-[255px] min-h-screen bg-aubergine flex flex-col flex-shrink-0">
      ...
      <div className="px-3 pb-5 mt-auto" ref={userMenuRef}>
        <div className="border-t border-white/10 pt-4">
          <div className="relative">
            ...
            >
              ...
              <svg
                className={`w-3.5 h-3.5 text-white/30 flex-shrink-0 transition-transform ${userMenuOpen ? 'rotate-180' : ''}`}
            ...
            {userMenuOpen && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-white rounded-card shadow-xl shadow-aubergine/20 border border-aubergine/10 overflow-hidden">
                <div className="px-4 py-3 border-b border-aubergine/5">
                  <p className="text-sm font-sans font-medium text-aubergine truncate">{displayName}</p>
                  <p className="text-xs font-sans text-aubergine/40 mt-0.5">Provider</p>
                </div>
                <div className="py-1">
                  <button
                    onClick={() => { setUserMenuOpen(false); router.push('/provider/settings') }}
