...
export default function SectionIntroLight({ section, intro, safetyFrame, onContinue }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Section name */}
      <p className="text-xs font-sans font-semibold tracking-[0.25em] uppercase text-violet mb-4">
        {section}
      </p>
      ...
      {safetyFrame ? (
        ...
        <div className="mb-8">
          <p className="text-lg text-beige/70 font-sans leading-relaxed">
            {intro}
          </p>
        </div>
      )}
