...
export const devFixtures = {
  ...
  unreadThreads: [
    ...
    {
      id: 'fx-thread-3',
      thread_id: 'fx-thread-3',
      body: 'I\'ve been feeling much better since we adjusted the dose. Wanted to say thank you.',
      created_at: hours(-18),
      unreadCount: 1,
      senderName: 'Dana Forsythe',
    },
  ],
  ...
  pendingRefills: [
    ...
    },
    {
      id: 'fx-refill-3',
      created_at: hours(-22),
      patient_note: 'Need this before my next appointment.',
      prescriptions: { medication_name: 'Testosterone', dosage: '0.5 mg/g cream', frequency: 'daily' },
      patients: {
        id: 'fx-p-2',
        profiles: { first_name: 'Priya', last_name: 'Desai' },
      },
    },
  ],
  ...
  recentCancellations: [
    {
      ...
      patients: { profiles: { first_name: 'Olivia', last_name: 'Reyes' } },
    },
    {
      id: 'fx-cancel-2',
      canceled_at: hours(-11),
      appointment_types: { name: 'Initial Consultation' },
      patients: { profiles: { first_name: 'Tara', last_name: 'Nguyen' } },
    },
  ],
  ...
  clinicalTasks: [
    {
      id: 'fx-task-1',
      patient_id: 'fx-p-1',
      title: 'Sarah Chen — reported chest tightness after starting Estradiol',
      body: 'Patient messaged this morning describing intermittent chest tightness starting 3 days after patch initiation. No prior cardiac history. Needs same-day review to rule out cardiovascular reaction before continuing therapy.',
      category: 'clinical',
      priority: 'red',
      status: 'new',
      owner_staff_id: null,
      ...
      closeout_safety_open: false,
    },
    {
      id: 'fx-task-2',
      patient_id: 'fx-p-3',
      title: 'Jessica Brooks — TSH 6.2, thyroid dysfunction may be affecting HRT response',
      body: 'Thyroid panel resulted this morning. TSH elevated at 6.2 mIU/L (ref 0.4–4.0). Free T4 low-normal at 0.8. Hypothyroidism can blunt response to estrogen therapy. Review before adjusting current Estradiol dose.',
      category: 'lab',
      priority: 'orange',
      status: 'new',
      owner_staff_id: null,
    ...
    },
    {
      id: 'fx-task-3',
      patient_id: 'fx-p-2',
      title: 'Maya Patel — skin irritation at patch site, asking about alternatives',
      body: 'Patient has developed erythema and pruritis at Vivelle-Dot application sites on both hips. Trying 3 rotation sites hasn\'t resolved it. Asking whether she can switch to gel or oral Estradiol. Needs prescription change.',
      category: 'message',
      priority: 'orange',
      status: 'acknowledged',
      owner_staff_id: null,
      ...
      requires_md_signoff: true,
      patient_notified: false,
      message_category: 'side_effect',
      closeout_safety_open: false,
    },
    {
      id: 'fx-task-4',
      patient_id: 'fx-p-5',
      title: 'Nina Martinez — 48h post-consult check-in, new on Estradiol + Progesterone',
      body: 'Initial consultation was 2 days ago. Started Estradiol 0.05mg patch + Prometrium 100mg nightly. First week on HRT — confirm tolerability, address any early side effects (bloating, spotting, breast tenderness) before next visit.',
      category: 'clinical',
      priority: 'yellow',
      status: 'new',
      owner_staff_id: null,
    ...
    },
    {
      id: 'fx-task-5',
      patient_id: 'fx-p-4',
      title: 'Aisha Williams — Estradiol patch refill due in 6 days, no request submitted',
      body: 'Current Rx: Vivelle-Dot 0.1mg, twice weekly, 90-day supply dispensed 84 days ago. No refill request received. Pharmacy lead time is 2–3 days. Proactively authorize refill or contact patient.',
      category: 'med',
      priority: 'yellow',
      status: 'new',
      owner_staff_id: null,
    ...
    },
    {
      id: 'fx-task-6',
      patient_id: 'fx-p-6',
      title: 'Hannah Goldberg — no symptom check-in in 14 days, WMI trend unknown',
      body: 'Last check-in was 14 days ago (WMI: 61). Patient is 8 weeks into HRT titration — regular tracking is essential to evaluate response. Nudge email sent 5 days ago with no response. Consider direct outreach.',
      category: 'clinical',
      priority: 'yellow',
      status: 'new',
      owner_staff_id: null,
