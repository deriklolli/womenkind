  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="font-serif text-3xl text-aubergine tracking-tight mb-2">Terms of Service</h1>
        ...
        <div className="space-y-8 text-sm font-sans text-aubergine/70 leading-relaxed">
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">2. Description of Services</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">3. Eligibility</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">4. Account Registration</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">5. Medical Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">6. Wearable Device Integration</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">7. Payment Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">8. Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">9. Prohibited Conduct</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">10. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">11. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">12. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">13. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-lg text-aubergine mb-3">14. Contact Us</h2>
            <p>
