  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="font-sans font-semibold text-3xl text-aubergine tracking-tight mb-2">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-sm font-sans text-aubergine/70 leading-relaxed">
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">3. How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">4. How We Share Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">5. Wearable Device Integration</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">6. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">7. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">8. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">9. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="font-sans font-semibold text-lg text-aubergine mb-3">10. Contact Us</h2>
            <p>
