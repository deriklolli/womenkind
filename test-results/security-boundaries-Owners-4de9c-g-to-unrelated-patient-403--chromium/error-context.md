...
- Name: security-boundaries.spec.ts >> Ownership checks — requires TEST_PROVIDER_EMAIL in .env.test >> H-NEW-4: prescribe — provider blocked from prescribing to unrelated patient (403)
- Location: tests/e2e/security-boundaries.spec.ts:202:7
