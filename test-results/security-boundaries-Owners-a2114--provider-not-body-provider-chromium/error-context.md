...
- Name: security-boundaries.spec.ts >> Ownership checks — requires TEST_PROVIDER_EMAIL in .env.test >> M-NEW-1: presentation — created record uses session provider, not body provider
- Location: tests/e2e/security-boundaries.spec.ts:218:7
